        ...
        with connection.cursor() as cursor:
            for index, row in df.iterrows():
                ...
                if result:
                    ...
                    # 如果不存在记录，则插入
                    sql_insert = "INSERT INTO goods (ASIN, URL, 主图, 标题, 配送, 品牌, 卖家, 国家, 卖家数, 上架日期, 上架天数, 是否新品, 大类, 大类BSR, 子类, 子类BSR, 评分, 评分数, 评分段, 变体数, 销售数量, 价格, 销售额, 近30天销量_父体, 近30天销量_子体, 毛利率, FBA费用, 全部流量词, 自然搜索词, 广告流量词, 搜索推荐词, 重量, 尺寸, Color, Style, `Collection time`, Coupon, Size, `Pattern Name`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
